                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <a href="{{ route('kategori-paket.create') }}" class="btn btn-outline-success btn-sm mb-2">Tambah</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-grid gap-2 col-6">
                                                    ...
                                                    @endphp
                                                    <a href="{{ route('kategori-paket.edit', $id) }}"
                                                        class="btn btn-outline-primary btn-sm btn-block">Edit</a>
                                                    <button type="button"
                                                        class="btn btn-outline-danger btn-sm btn-block"
                                                        onclick="tampil('{{ route('kategori-paket.destroy', $id) }}')">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
